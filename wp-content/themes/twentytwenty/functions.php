...
function twentytwenty_register_styles() {
	...
	wp_enqueue_script( 'twentytwenty-main', get_template_directory_uri() . '/assets/js/main.js', array(), _S_VERSION, true );

	wp_localize_script('twentytwenty-main', 'pyramid', array( 
		'ajaxurl' => admin_url('admin-ajax.php'), 
		'sitekey' => RECAPTCHA_SITE_KEY,
	)); 
	// google recaptcha
	wp_enqueue_script('twentytwenty-google-recaptcha', "https://www.google.com/recaptcha/api.js?render=".RECAPTCHA_SITE_KEY, array(), _S_VERSION, true);
...
function wp_load_admin_scripts(){
	// Load bootstrap css
	wp_enqueue_style('bootstrap.min.css', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), 1, 'all');

	// Load bootstrap datepicker css
	wp_enqueue_style( 'datepicker.css', get_template_directory_uri() . '/assets/css/datepicker.css', array(), 1, 'all');

	// Load bootstrap JS
	wp_enqueue_script('bootstrap.min.js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), 1, true);

	// Load bootstrap datepicker js
	wp_enqueue_script('bootstrap-datepicker.js', get_template_directory_uri() . '/assets/js/bootstrap-datepicker.js', array('jquery'), 1, true);

	// Load main JS file for admin
	wp_enqueue_script('admin.js', get_template_directory_uri().'/assets/js/admin.js', array('jquery'), 1, true);
}
...
// Load all action and filter hooks's function
require get_template_directory() . '/inc/common-functions.php';

// Load add product frontend
require get_template_directory() . '/inc/custom-add-product-frontend.php';
